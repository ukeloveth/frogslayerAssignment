...
function jg(){return{innertubeApiKey:N("INNERTUBE_API_KEY",void 0),innertubeApiVersion:N("INNERTUBE_API_VERSION",void 0),Ha:N("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Ia:N("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:N("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),Ka:N("INNERTUBE_CONTEXT_HL",void 0),Ja:N("INNERTUBE_CONTEXT_GL",void 0),La:N("INNERTUBE_HOST_OVERRIDE",void 0)||"",Na:!!N("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),Ma:!!N("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
...
oa(V,Jg);function Qg(a){V.call(this,"MISSING_OBJECT_STORE",{Pa:a},Ng.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,Qg.prototype)}
...
function ih(a,b){return fh(a,["LogsRequestsStore"],{mode:"readwrite",D:!0},function(c){c=c.objectStore("LogsRequestsStore");return X(c.h.put(b,void 0))})}
n.objectStoreNames=function(){return Array.from(this.h.objectStoreNames)};
function fh(a,b,c,d){return I(a,function f(){var g=this,h,k,l,m,q,t,p,x,A,v,K,P;return y(f,function(E){switch(E.h){case 1:var O={mode:"readonly",D:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?O.mode=c:Object.assign(O,c);h=O;g.transactionCount++;k=h.D?3:1;l=0;case 2:if(m){E.v(3);break}l++;q=Math.round(R());sa(E,4);t=g.h.transaction(b,h.mode);O=new jh(t);O=kh(O,d);return w(E,O,6);case 6:return p=E.i,x=Math.round(R()),lh(g,q,x,l,void 0,b.join(),h),E.return(p);case 4:A=ta(E);v=Math.round(R());
K=Tg(A,g.h.name,b.join(),g.h.version);if((P=K instanceof V&&!K.h)||l>=k)lh(g,q,v,l,K,b.join(),h),m=K;E.v(2);break;case 3:return E.return(Promise.reject(m))}})})}
...
n.index=function(a){try{return new ph(this.h.index(a))}catch(b){if(b instanceof Error&&"NotFoundError"===b.name)throw new Rg(a,this.h.name);throw b;}};
n.getName=function(){return this.h.name};
n.keyPath=function(){return this.h.keyPath};
function oh(a,b,c){a=a.h.openCursor(b.query,b.direction);return qh(a).then(function(d){return dh(d,c)})}
...
function kh(a,b){var c=new Promise(function(d,e){try{Yg(b(a).then(function(f){d(f)}),e)}catch(f){e(f),a.abort()}});
...
function rh(a,b,c){a=a.h.openCursor(void 0===b.query?null:b.query,void 0===b.direction?"next":b.direction);return qh(a).then(function(d){return dh(d,c)})}
...
n.update=function(a){return X(this.cursor.update(a))};function th(a,b,c){return new Promise(function(d,e){function f(){t||(t=new eh(g.result,{closed:q}));return t}
...
function zh(a){return I(this,function c(){var d;return y(c,function(e){if(1==e.h)return w(e,yh.open(),2);d=e.i;return e.return(fh(d,["databases"],{D:!0,mode:"readwrite"},function(f){var g=f.objectStore("databases");return g.get(a.actualName).then(function(h){if(h?a.actualName!==h.actualName||a.publicName!==h.publicName||a.userIdentifier!==h.userIdentifier:1)return X(g.h.put(a,void 0)).then(function(){})})}))})})}
function Ah(a){return I(this,function c(){var d;return y(c,function(e){if(1==e.h)return a?w(e,yh.open(),2):e.return();d=e.i;return e.return(d.delete("databases",a))})})}
...
oa(Mh,wh);function Nh(a){var b;return function(){b||(b=new Mh("LogsDatabaseV2",a));return b}}
...
function Sh(){return I(this,function b(){var c,d,e,f,g,h,k;return y(b,function(l){if(1==l.h)return c={startTime:R(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},w(l,Ph().open(),2);if(3!=l.h)return d=l.i,e=N("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=["NEW",e,0],g=["NEW",e,R()],h=IDBKeyRange.bound(f,g),k=void 0,w(l,fh(d,["LogsRequestsStore"],{mode:"readwrite",D:!0},function(m){return rh(m.objectStore("LogsRequestsStore").index("newRequestV2"),{query:h,direction:"prev"},function(q){q.cursor.value&&(k=
q.cursor.value,k.status="QUEUED",q.update(k))})}),3);
c.Sa=R();Rh(c);return l.return(k)})})}
function Th(a){return I(this,function c(){var d;return y(c,function(e){if(1==e.h)return w(e,Ph().open(),2);d=e.i;return e.return(fh(d,["LogsRequestsStore"],{mode:"readwrite",D:!0},function(f){var g=f.objectStore("LogsRequestsStore");return g.get(a).then(function(h){if(h)return h.status="QUEUED",X(g.h.put(h,void 0)).then(function(){return h})})}))})})}
function Uh(a){return I(this,function c(){var d;return y(c,function(e){if(1==e.h)return w(e,Ph().open(),2);d=e.i;return e.return(fh(d,["LogsRequestsStore"],{mode:"readwrite",D:!0},function(f){var g=f.objectStore("LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",h.sendCount+=1,X(g.h.put(h,void 0)).then(function(){return h})):W.resolve(void 0)})}))})})}
...
oa(Y,L);function bi(){if(!Y.h){var a=B("yt.networkStatusManager.instance")||new Y;D("yt.networkStatusManager.instance",a);Y.h=a}return Y.h}
...
oa(di,L);di.prototype.J=function(){var a=B("yt.networkStatusManager.instance.isNetworkAvailable").bind(this.i);return a?a():!0};
...
b=void 0===b?{}:b;Q("skip_is_supported_killswitch")?Fh().then(function(d){c(d)}):c(oi())}
function qi(){var a=this;if(!oi())throw Ug("throttleSend");fi||(fi=lf(function(){return I(a,function c(){var d;return y(c,function(e){if(1==e.h)return w(e,Sh(),2);if(3!=e.h)return d=e.i,d?w(e,ni(d),3):(nf(fi),fi=0,e.return());fi&&(fi=0,qi());e.h=0})})},100))}
function ni(a){return I(this,function c(){var d,e,f;return y(c,function(g){switch(g.h){case 1:d=oi();if(!d)throw e=Ug("immediateSend"),e;if(void 0===a.id){g.v(2);break}return w(g,Th(a.id),3);case 3:(f=g.i)?a=f:Me(Error("The request cannot be found in the database."));case 2:var h=a.timestamp;if(!(2592E6<=R()-h)){g.v(4);break}Me(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){g.v(5);break}return w(g,Vh(a.id),5);case 5:return g.return();case 4:h=a=ri(a);var k,
...
function ri(a){var b=this;if(!oi())throw Ug("updateRequestHandlers");var c=a.options.onError?a.options.onError:function(){};
...
k,value:String(l[k])});l=N("SERVER_NAME",void 0);m=N("SERVER_VERSION",void 0);l&&m&&(q.kvPairs.push({key:"server.name",value:l}),q.kvPairs.push({key:"server.version",value:m}));f={errorMetadata:q,stackTrace:h,logMessage:f}}f&&(ti("clientError",f),("ERROR"===g||Q("errors_flush_gel_always_killswitch"))&&eg())}if(!Q("suppress_error_204_logging")){f=e;g=f.params||{};d={urlParams:{a:"logerror",t:"jserror",type:f.name,msg:f.message.substr(0,250),line:f.lineNumber,level:d,"client.name":g.name},postParams:{url:N("PAGE_NAME",
...
f)}xf(N("ECATCHER_REPORT_HOST","")+"/error_204",d)}Gi.add(e.message);Hi++}}}}}else throw v;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function ej(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
oa(gj,Yi);n=gj.prototype;n.ka=function(){var a=Z(this.i,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=Z(this.i,"embedConfig")){if(C(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
